import "./Win95StartSubMenuOption.js";

class Win95StartSubMenu extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    ...
    <style>${Win95StartSubMenu.styles}</style>
    <div class="container">
...
customElements.define("win95-start-sub-menu", Win95StartSubMenu);
